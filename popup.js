...
const OTHER_LANGS = [
  ...
  ['as','Assamese'],['az','Azerbaijani'],['ba','Bashkir'],['eu','Basque'],
  ...
  ['fo','Faroese'],['fi','Finnish'],['gl','Galician'],['ka','Georgian'],
  ['el','Greek'],['gu','Gujarati'],['ht','Haitian Creole'],['ha','Hausa'],
  ['haw','Hawaiian'],['he','Hebrew'],['hu','Hungarian'],['is','Icelandic'],
  ...
  ['no','Norwegian'],['nn','Nynorsk'],['oc','Occitan'],['or','Oriya'],
  ['ps','Pashto'],['fa','Persian'],['pl','Polish'],['pa','Punjabi'],
  ['ro','Romanian'],['sa','Sanskrit'],['sr','Serbian'],['sh','Serbo-Croatian'],
  ['sn','Shona'],['sd','Sindhi'],['si','Sinhala'],['sk','Slovak'],
  ['sl','Slovenian'],['so','Somali'],['su','Sundanese'],['sw','Swahili'],
  ['sv','Swedish'],['tl','Tagalog'],['tg','Tajik'],['ta','Tamil'],
  ['tt','Tatar'],['te','Telugu'],['th','Thai'],['bo','Tibetan'],
  ['tr','Turkish'],['tk','Turkmen'],['ug','Uighur'],['uk','Ukrainian'],
  ['ur','Urdu'],['uz','Uzbek'],['vi','Vietnamese'],['vo','Volapuk'],
  ['wa','Walloon'],['cy','Welsh'],['xh','Xhosa'],['yi','Yiddish'],
  ['yo','Yoruba'],['zu','Zulu']
];
